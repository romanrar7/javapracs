public class Pants extends Clothes {
    ...
    public void setWaist(int waist) {
        if (waist < 20 || waist > 60) throw new IllegalArgumentException("Некоректний обхват");
        this.waist = waist;
    }

    public int getLength() { return length; }
    public void setLength(int length) {
        if (length < 50 || length > 130) throw new IllegalArgumentException("Некоректна довжина");
        this.length = length;
    }
