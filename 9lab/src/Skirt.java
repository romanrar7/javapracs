public class Skirt extends Clothes {
    ...
    public void setLengthCm(int lengthCm) {
        if (lengthCm < 20 || lengthCm > 120) throw new IllegalArgumentException("Некоректна довжина");
        this.lengthCm = lengthCm;
    }

    public String getCut() { return cut; }
    public void setCut(String cut) {
        if (cut == null || cut.trim().isEmpty()) throw new IllegalArgumentException("Фасон порожній");
        this.cut = cut.trim();
    }
