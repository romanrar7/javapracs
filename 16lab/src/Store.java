...
/**
 * РњР°РіР°Р·РёРЅ РѕРґСЏРіСѓ Р· РєРѕР»РµРєС†С–С”СЋ С‚Р° РєС–Р»СЊРєС–СЃС‚СЋ С‚РѕРІР°СЂС–РІ.
 */
public class Store {
    private String name;
    ...
    public void setName(String name) {
        if (name == null || name.trim().isEmpty()) {
            throw new IllegalArgumentException("РќР°Р·РІР° РјР°РіР°Р·РёРЅСѓ РЅРµ РјРѕР¶Рµ Р±СѓС‚Рё РїРѕСЂРѕР¶РЅСЊРѕСЋ");
        }
        this.name = name.trim();
    }
    ...
    public void setAddress(String address) {
        if (address == null || address.trim().isEmpty()) {
            throw new IllegalArgumentException("РђРґСЂРµСЃР° РЅРµ РјРѕР¶Рµ Р±СѓС‚Рё РїРѕСЂРѕР¶РЅСЊРѕСЋ");
        }
    ...
    public void addNewClothes(Clothes clothes, int quantity) {
        if (clothes == null) {
            throw new IllegalArgumentException("РћР±'С”РєС‚ РѕРґСЏРіСѓ РЅРµ РјРѕР¶Рµ Р±СѓС‚Рё null");
        }
        if (quantity <= 0) {
            throw new IllegalArgumentException("РљС–Р»СЊРєС–СЃС‚СЊ РјР°С” Р±СѓС‚Рё Р±С–Р»СЊС€Рµ 0");
        }
    ...
    public void delete(Clothes clothes) {
        if (clothes == null) {
            throw new IllegalArgumentException("РћР±'С”РєС‚ РґР»СЏ РІРёРґР°Р»РµРЅРЅСЏ РЅРµ Р·Р°РґР°РЅРѕ");
        }
        for (int i = 0; i < items.size(); i++) {
        ...
        throw new IllegalStateException("РўРѕРІР°СЂ РЅРµ Р·РЅР°Р№РґРµРЅРѕ РІ РјР°РіР°Р·РёРЅС–");
    }

    public void updateQuantity(Clothes clothes, int newQuantity) {
        if (!quantities.containsKey(clothes.getUuid())) {
            throw new IllegalStateException("РўРѕРІР°СЂ РЅРµ Р·РЅР°Р№РґРµРЅРѕ РґР»СЏ РѕРЅРѕРІР»РµРЅРЅСЏ");
        }
        if (newQuantity <= 0) {
            throw new IllegalArgumentException("РљС–Р»СЊРєС–СЃС‚СЊ РјР°С” Р±СѓС‚Рё Р±С–Р»СЊС€Рµ 0");
        }
